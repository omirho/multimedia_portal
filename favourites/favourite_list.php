...
<body background="../play/white1.jpg" bgproperties="fixed" style="background-size:cover">
            ...
            <div class="content">
                ...
                <ul class="ca-menu">
                    ...
                    <!--li>
                            ...
                            <div>
                            <p style="font-size:20px;margin-left: 80px;"> <a href="../play/sort1.php?id=0">Sort by ratings</a><a href="../play/sort1.php?id=1">Sort by views</a></p>
                          </div>
...
<script type="text/javascript" src="js/bootstrap/bootstrap-dropdown.js"></script>
     ...
     <div class="row" style="float:right;width:1000px;margin-top:200px; margin-bottom:80px;">
        ...
        $array=  explode(';', $text);
        $usersStr = implode(',', $array);
        
        $res=mysqli_query($con, "SELECT * from multimedia.games WHERE id IN ($usersStr)");
      ...
      echo '<div class="thumbnail">';
         ...
         echo '../games/';
         echo $genre;
         echo '/images/'.$row['image_location'].'">';
      echo '</div>';
